...
-- C	=>  Location: PIN_L22,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \Y~0_combout\ = ( \C~input_o\ & ( (\B~input_o\) # (\A~input_o\) ) ) # ( !\C~input_o\ & ( (\A~input_o\ & \B~input_o\) ) )
